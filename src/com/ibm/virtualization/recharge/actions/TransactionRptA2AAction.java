 ...
 * @author Paras
 */
public class TransactionRptA2AAction extends DispatchAction {

	/* Logger for this Action class. */

	private static Logger logger = Logger
			.getLogger(TransactionRptA2AAction.class.getName());

	/**
	 * This method initializes and opens the transactionReportA2A.jsp page
	 * 
	 * @param mapping
	 * @param form
	 * @param request
	...
	public ActionForward init(ActionMapping mapping, ActionForm form,
		...
		if (!authorizationService.isUserAuthorized(sessionContext
				.getGroupId(),ChannelType.WEB, AuthorizationConstants.ROLE_VIEW_A2A_TRANSACTION_REPORT)) {
			logger.info(" user not auth to perform this ROLE_VIEW_A2A_TRANSACTION_REPORT activity  ");
	...
	public ActionForward searchReportData(ActionMapping mapping,
		...
		try {
			...
			/* call service to find all reports */
	...
	public ActionForward searchReportData1(ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws VirtualizationServiceException {
		logger.info(" Started... ");
		ActionErrors errors = new ActionErrors();
		...
		try {
			...
			/* call service to find all reports */
			ArrayList recordList = reportService.getTransactionRptA2AData(reportInputs,pagination.getLowerBound(),pagination.getUpperBound(),true);
	...
	public ActionForward exportData(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			ReportService reportService = new ReportServiceImpl();
			ArrayList recordList = reportService.getTransactionRptA2AData(reportInputs,0,0,true);
		...
		logger.info("Executed... ");
		return mapping.findForward(Constants.EXPORT_A2A_REPORT_SUCCESS);
	}
