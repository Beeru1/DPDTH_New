...
public class RegistrationOfAllDTO implements Serializable {
	...
	protected int locId;
	protected String circleCodeFrom;
	protected ArrayList subUserList;
	protected String regNumberLabel;
	...
	/**
	 * @return the regNumberLabel
	 */
	public String getRegNumberLabel() {
		return regNumberLabel;
	}



	/**
	 * @param regNumberLabel the regNumberLabel to set
	 */
	public void setRegNumberLabel(String regNumberLabel) {
