...
//import com.ibm.virtualization.ussdactivationweb.dto.USSDUtilityDTO;
   ...
   public class USSDCommonUtility {
	 ...
	 * This method is to fetch the circle list.
	 */
	    public static ArrayList getCircleList() throws Exception 
		{
	    	logger.debug("Entering getCircleList().method of CircleMasterAction");
			...
			try{
				...
				logger.info("init Inititalization Error - " + e.getMessage());
				
			} finally {
				logger.debug("Exiting getCircleList().method of CircleMasterAction");
			}
			return circleList;
	        }
	    
	    
	    public static ArrayList getCityList() throws Exception 
		{
	    	logger.debug("Entering getCityList().method of CircleMasterAction");
	    	ViewEditCircleMasterDAOImpl dao = null;
