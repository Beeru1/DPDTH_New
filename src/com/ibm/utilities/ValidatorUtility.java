...
public class ValidatorUtility {
	...
	/**
	 * This method returns true if the string does not contain any of the junk
	 * charcters tested for
	 * 
	 * @param String
	 * @return boolean
	 */
	...
	// added by Arti
	public static boolean isAlfabetSpace(String str) {
	...
	public static boolean isYesNo(String str) {
		...
		if(str.trim().equalsIgnoreCase("Y") || str.trim().equalsIgnoreCase("N") || str.trim().equalsIgnoreCase("")){
			return true;
		}
		else {
			return false;
	...
	public static boolean isAlphaNumericSpace(String strString) {
		// checking for null
		...
		/*
		// Set the AlphaNumeric pattern string
		Pattern p = Pattern.compile("^[a-zA-Z][a-zA-Z0-9][a-zA-Z\\s]+");
		...
		*/
		...
		boolean isMach = pattern.matcher(strString).matches();
		//System.out.println("isMach =    "+isMach);
		if (isMach) {
			return true;
		} else {
			return false;
	...
	/**
	 * This method returns true if the string provided as an argument is a valid
	 * number and -ve or else returns false.
	 * 
	 * @param number
	 * @return boolean
	 */
	public static boolean isValidPosNegNumber(String number) {
		// checking for null
		if (number == null) {
			return false;
		}
