...
public class SQLConstants {
	...
	public static final String FTA_JNDI_NAME="jdbc/DPDTH" ;
	public static final String FTA_SCHEMA="DP" ;
	public static final String PRODCAT_JNDI_NAME="jdbc/DPDTH" ;
	public static final String PRODCAT_SCHEMA="DP" ;
	public static final String DISTPORTAL_JNDI_NAME="jdbc/DPDTH" ;
	public static final String DISTPORTAL_SCHEMA="DP" ;
