...
public interface CircleMasterInterface {
	...
	public static final String SQL_SELECT_CIRCLE = new StringBuffer(500)
			...
			.append("cm.CREATED_BY, cm.MODIFIED_DT , cm.MODIFIED_BY , cm.MINSAT_CHECK_REQ, cm.AEPF_CHECK_REQ , cm.WELCOME_MSG ,cm.SIM_REQ_CHECK FROM ")
			.append(SQLConstants.PRODCAT_SCHEMA)
			.append(".DP_CIRCLE_MSTR cm,")
			.append(SQLConstants.PRODCAT_SCHEMA)
			.append(".DP_HUB_MSTR hm ").toString();
	
	public static final String HUBCODE_OF_CIRCLE = new StringBuffer(500)
	.append("SELECT CIRCLE_CODE, CIRCLE_NAME,HUB_CODE FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_CIRCLE_MSTR WHERE CIRCLE_CODE = ? ")
	.toString();

	public static final String SQL_INSERT_CIRCLE = new StringBuffer(500)
			.append("INSERT INTO ")
			.append(SQLConstants.PRODCAT_SCHEMA)
			.append(".DP_CIRCLE_MSTR(CIRCLE_ID,CIRCLE_CODE, CIRCLE_NAME,HUB_CODE, STATUS, CREATED_DT, ")
			.append(" CREATED_BY, MODIFIED_DT , MODIFIED_BY , MINSAT_CHECK_REQ, AEPF_CHECK_REQ ,WELCOME_MSG,SIM_REQ_CHECK) ")
			.append(" VALUES (NEXT VALUE FOR PRODCAT.DP_CIRCLE_ID_SEQ, ?, ?, ? ,?, current timestamp, ?, current timestamp, ?, ?, ?,?,?) ")
			.append(" WITH UR").toString();

	public static final String SQL_CIRCLE_UPDATE_WITH_ID = new StringBuffer(500)
			.append("UPDATE ")
			.append(SQLConstants.PRODCAT_SCHEMA)
			.append(".DP_CIRCLE_MSTR SET CIRCLE_NAME =?,MODIFIED_DT=current timestamp,")
			.append("MODIFIED_BY=?,STATUS=?, MINSAT_CHECK_REQ=?, AEPF_CHECK_REQ=?, WELCOME_MSG=?, SIM_REQ_CHECK=? WHERE CIRCLE_CODE=? ")
			.append(" WITH UR").toString();
	...
	public static final String CIRCLE_LIST = new StringBuffer(500)
			...
			.append(SQLConstants.PRODCAT_SCHEMA)
			.append(".DP_HUB_MSTR hm,")
			.append(SQLConstants.PRODCAT_SCHEMA)
			.append(".DP_CIRCLE_MSTR cm WHERE hm.HUB_CODE = cm.HUB_CODE ORDER BY cm.CIRCLE_NAME ) a )b ")
	...
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_LOCATION_DATA WHERE LOC_MSTR_ID = ? AND PARENT_ID = ? AND STATUS = ? ORDER BY UPPER (LOCATION_NAME) ")
	.toString();
	
	public static final String RETRIEVE_LOCATION_LIST_ACTIVE_ZONE= new StringBuffer(500)
	.append("SELECT ZONE_ID as LOC_DATA_ID,ZONE_NAME as LOCATION_NAME,STATUS,CREATED_BY,CREATED_DT,UPDATED_BY as MODIFIED_BY,UPDATED_DT as MODIFIED_DT FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_ZONE_MASTER WHERE CIRCLE_ID = ? AND STATUS = ? ORDER BY UPPER (ZONE_NAME) ")
	.toString();
	
	public static final String RETRIEVE_LOCATION_LIST_ACTIVE_CITY= new StringBuffer(500)
	.append("SELECT CITY_ID as LOC_DATA_ID,CITY_NAME as LOCATION_NAME,STATUS,CREATED_BY,CREATED_DT,UPDATED_BY as MODIFIED_BY,UPDATED_DT as MODIFIED_DT FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	...
	.append("SELECT LOC_DATA_ID,LOCATION_NAME,STATUS,CREATED_BY,CREATED_DT,MODIFIED_BY,MODIFIED_DT FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_LOCATION_DATA WHERE LOC_MSTR_ID = ? AND PARENT_ID = ?")
	.toString();
	...
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_LOCATION_DATA WHERE LOC_MSTR_ID = ? AND PARENT_ID = ? ORDER BY UPPER(LOCATION_NAME)) a )b ")
	.append("Where rnum<=? and rnum>=? ")
	.toString();
	
	public static final String RETRIEVE_LOCATION_LIST_PAGE_ZONE= new StringBuffer(500)
	.append("SELECT * from (select a.*,ROW_NUMber() over() rnum FROM (SELECT ZONE_ID as LOC_DATA_ID,ZONE_NAME as LOCATION_NAME,STATUS,CREATED_BY,CREATED_DT,UPDATED_BY as MODIFIED_BY,UPDATED_DT as MODIFIED_DT FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_ZONE_MASTER WHERE CIRCLE_ID=? ORDER BY UPPER(ZONE_NAME)) a )b ")
	.append("Where rnum<=? and rnum>=? with ur")
	.toString();
	
	public static final String RETRIEVE_LOCATION_LIST_PAGE_CITY= new StringBuffer(500)
	.append("SELECT * from (select a.*,ROW_NUMber() over() rnum FROM (SELECT CITY_ID as LOC_DATA_ID,CITY_NAME as LOCATION_NAME,STATUS,CREATED_BY,CREATED_DT,UPDATED_BY as MODIFIED_BY,UPDATED_DT as MODIFIED_DT FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".VR_CITY_MASTER WHERE ZONE_ID=? ORDER BY UPPER(CITY_NAME)) a )b ")
	.append("Where rnum<=? and rnum>=? with ur")
	.toString();
	
	public static final String COUNT_LOCATION_LIST_ZONE= new StringBuffer(500)
	.append("SELECT COUNT(*) FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_ZONE_MASTER WHERE CIRCLE_ID=? with ur")
	.toString();
	
	public static final String COUNT_LOCATION_LIST_CITY= new StringBuffer(500)
	.append("SELECT COUNT(*) FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".VR_CITY_MASTER WHERE ZONE_ID = ? with ur")
	.toString();
	...
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_LOCATION_DATA WHERE LOC_DATA_ID = ?")
	.toString();
	
	public static final String RETRIEVE_LOCATION_DETAILS_ZONE = new StringBuffer(500)
	.append("SELECT ZONE_NAME as LOCATION_NAME,CIRCLE_ID as PARENT_ID,STATUS,CREATED_BY,CREATED_DT,UPDATED_BY as MODIFIED_BY,UPDATED_DT as MODIFIED_DT,3 as LOC_MSTR_ID FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_ZONE_MASTER WHERE ZONE_ID = ? with ur")
	.toString();

	public static final String RETRIEVE_LOCATION_DETAILS_CITY = new StringBuffer(500)
	.append("SELECT CITY_NAME as LOCATION_NAME,ZONE_ID as PARENT_ID,STATUS,CREATED_BY,CREATED_DT,UPDATED_BY as MODIFIED_BY,UPDATED_DT as MODIFIED_DT,4 as LOC_MSTR_ID FROM ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".VR_CITY_MASTER WHERE CITY_ID = ? with ur")
	.toString();
	
	public static final  String GET_NEXT_LOC_DATA_ID= new StringBuffer(500)
	.append("VALUES NEXTVAL FOR ").append(SQLConstants.PRODCAT_SCHEMA).append(".DP_LOCATION_DATA_ID_SEQ").toString();
	
	public static final  String UPDATE_LOCATION_DETAILS =new StringBuffer(500)
	  .append("UPDATE ")
	  .append(SQLConstants.PRODCAT_SCHEMA)
	  .append(".DP_LOCATION_DATA SET LOCATION_NAME= ?,STATUS= ?,MODIFIED_BY =?,MODIFIED_DT= CURRENT TIMESTAMP " )
	  .append("WHERE LOC_DATA_ID=?").toString();
	
	public static final  String UPDATE_LOCATION_DETAILS_ZONE =new StringBuffer(500)
	  .append("UPDATE ")
	  .append(SQLConstants.PRODCAT_SCHEMA)
	  .append(".DP_ZONE_MASTER SET ZONE_NAME= ?,STATUS= ?,UPDATED_BY =?,UPDATED_DT= CURRENT TIMESTAMP " )
	  .append("WHERE ZONE_ID=?").toString();
	
	public static final  String UPDATE_LOCATION_DETAILS_CITY =new StringBuffer(500)
	  .append("UPDATE ")
	  .append(SQLConstants.PRODCAT_SCHEMA)
	  .append(".VR_CITY_MASTER SET CITY_NAME= ?,STATUS= ?,UPDATED_BY =?,UPDATED_DT= CURRENT TIMESTAMP " )
	  .append("WHERE CITY_ID=?").toString();
	
	public static final  String VALIDATE_LOCATION_NAME=new StringBuffer(500)
	 .append("SELECT LOCATION_NAME , PARENT_ID FROM ")
	 .append(SQLConstants.PRODCAT_SCHEMA)
	 .append(".DP_LOCATION_DATA WHERE LOWER(trim(LOCATION_NAME))= ? AND PARENT_ID=(SELECT PARENT_ID FROM ")
	 .append(SQLConstants.PRODCAT_SCHEMA)
	 .append(".DP_LOCATION_DATA WHERE LOC_DATA_ID = ?) ")
	 .append("WITH UR").toString();
	...
	public static final  String VALIDATE_LOCATION_NAME_PARENT_ID=new StringBuffer(500)
	 .append("SELECT LOCATION_NAME , PARENT_ID FROM ")
	 .append(SQLConstants.PRODCAT_SCHEMA)
	 .append(".DP_LOCATION_DATA WHERE LOWER(trim(LOCATION_NAME))= ? AND PARENT_ID= ? ")
	...
	.append("from ")
	 .append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_LOCATION_DATA  sub, temptab super ")
	...
	public static final String UPDATE_PARENT_ID_ZONE = new StringBuffer(500)
	.append("UPDATE ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".VR_CITY_MASTER ") 
	.append("SET ZONE_ID = ? " )
	.append("where ZONE_ID=? " ).toString();
	
	public static final String UPDATE_PARENT_ID_CITY = new StringBuffer(500)
	.append("UPDATE ")
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_BEAT_MASTER ") 
	.append("SET CITY_ID = ? " )
	.append("where CITY_ID=? " ).toString();
	...
	public static final String GET_LOCATION_HIERARCHIAL_ZONE = new StringBuffer(500)
	.append("select CITY_NAME as LOCATION_NAME,CITY_ID as LOC_DATA_ID from ") 
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".VR_CITY_MASTER where ZONE_ID=? and STATUS=?") 
	.append(" WITH UR ").toString();
	
	public static final String GET_LOCATION_HIERARCHIAL_CITY = new StringBuffer(500)
	.append("select BEAT_NAME as LOCATION_NAME,BEAT_CODE as LOC_DATA_ID from ") 
	.append(SQLConstants.PRODCAT_SCHEMA)
	.append(".DP_BEAT_MASTER where CITY_ID=? and STATUS=?") 
	.append(" WITH UR ").toString();
