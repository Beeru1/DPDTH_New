 ...
 * 
 */
public interface DPCreateAccountDao {
	 ...
	 * @throws DAOException
	 */
	public ArrayList getChildAccountList(ReportInputs mtDTO) throws DAOException;
	...
	public String getMobileNoForSms(long accountId,int smsAlertType) throws DAOException;
...
//	 For Cannon system
	...
	*/
	...
	public String isNewUser(long login) throws DAOException;
	...
	public int terminateAccount(DPCreateAccountDto accountDto)throws DAOException; //Added by Neetika 
