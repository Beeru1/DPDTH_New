...
//import com.ibm.dp.dto.CircleMasterDTO;
...
{
	private static final Logger logger = Logger.getLogger(ViewEditCircleMasterDAOImpl.class.toString());
	 ...
	 **
	public int countCircle() throws DPServiceException {
		logger
		...
		try {
			...
			noofPages = Pagination.getPaginationSize(noofRow);
		...
		try {
			...
			if (bFlag) {
				...
				if (fail) {
					...
					prepareStatement.setString(8, dto.getCircleCode());
