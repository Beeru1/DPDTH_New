...
public class LocationDataBean extends ActionForm{
	...
	public int getLocMasterIdHidden() {
		return locMasterIdHidden;
	}

	public void setLocMasterIdHidden(int locMasterIdHidden) {
		this.locMasterIdHidden = locMasterIdHidden;
	}
