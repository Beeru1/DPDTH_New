...
public class InterSsdTransferAdminBean  extends ValidatorForm {
	...
	private Integer businessCat;
	private List<CircleDto> busCatList = new ArrayList<CircleDto>();
	
	private String docketNumber;
	private String courierAge;
	private String dcRem;
	...
	public String getCourierAge() {
		return courierAge;
	}
	public void setCourierAge(String courierAge) {
		this.courierAge = courierAge;
	}
	...
	public Integer getBusinessCat() {
		return businessCat;
	}
	public void setBusinessCat(Integer businessCat) {
