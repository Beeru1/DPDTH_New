...
public class DPInterSSDTransferBulkUploadBean  extends ActionForm

{
	...
	public List<DPInterSSDListTransferBulkUploadDto> getPendingListTransferBulkUpload() {
		return pendingListTransferBulkUpload;
	}
	public void setPendingListTransferBulkUpload(
			List<DPInterSSDListTransferBulkUploadDto> pendingListTransferBulkUpload) {
