...
//	 Ended by ARTI for warehaouse list box BFR -11 release2
    ...
    // Addede by sugandha for retailer transaction type
    private ArrayList retailerTransList;
    private int transactionId;
    //Added by sugandha to fetch district list
    private int accountDistrictId;
	...
	public int getAccountDistrictId() {
		return accountDistrictId;
	}

	public void setAccountDistrictId(int accountDistrictId) {
		this.accountDistrictId = accountDistrictId;
	}
	...
	public ArrayList getRetailerTransList() {
		return retailerTransList;
	}

	public void setRetailerTransList(ArrayList retailerTransList) {
		this.retailerTransList = retailerTransList;
	}
...
//end by saumya
//	public ArrayList<SWLocatorFormBean> getSwConcatenatedLocatorList() {
//		return swConcatenatedLocatorList;
//	}
//
//	public void setSwConcatenatedLocatorList(
//			ArrayList<SWLocatorFormBean> swConcatenatedLocatorList) {
//		this.swConcatenatedLocatorList = swConcatenatedLocatorList;
//	}
