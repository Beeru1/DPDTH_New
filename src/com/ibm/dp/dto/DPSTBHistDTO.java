...
public class DPSTBHistDTO implements Comparator<DPSTBHistDTO>{
	...
	private Timestamp tsSTBDate = null;
	
	
	//added for STB History 25/06/13
	
	public Timestamp getTsSTBDate() {
		return tsSTBDate;
	}

	public void setTsSTBDate(Timestamp tsSTBDate) {
		this.tsSTBDate = tsSTBDate;
	}
	...
	public int compare(DPSTBHistDTO obj1, DPSTBHistDTO obj2)
	{
		if(obj1.getStrSerialNo().compareTo(obj2.getStrSerialNo())>0)
		{
			return obj1.getTsSTBDate().compareTo(obj2.getTsSTBDate());
		}
		else
			return obj1.getStrSerialNo().compareTo(obj2.getStrSerialNo());
	}
