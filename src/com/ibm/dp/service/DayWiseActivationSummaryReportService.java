...
public interface DayWiseActivationSummaryReportService {
	GenericReportsOutputDto getAccountDetailExcel(DayWiseActivationSummaryReportDTO reportDto) throws VirtualizationServiceException;
