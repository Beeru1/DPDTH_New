...
public interface DPCreateAccountITHelpService {
	...
	/**
	 * This mehtod creates a new account for ID Helpdesk User
	 * 
	 * @param loginBean
	 * @param accountId
	 * @return
...
*/
	...
	public ArrayList getIdHelpDeskUserAccountList(ReportInputs mtDTO) throws VirtualizationServiceException;
...
*/
	...
	int parentCircleId,String parentCircleIdList, String accountLevelId, int lb, int ub,int accountLevel,DPCreateAccountDto accountDTO)
	throws VirtualizationServiceException;
...
* @throws VirtualizationServiceException
*/
	public int getParentAccountListCount(String searchType, String searchValue,UserSessionContext sessionContext, int parentCircle,
	String parentCircleIdList , String accountLevelId) throws VirtualizationServiceException;
...
//		 For cannon
		...
		public String generatePassword(String accountName)throws VirtualizationServiceException;
		
		public void sendMail(String email, String accountName, String accountCode, String default_password)throws VirtualizationServiceException ;
		...
		public ArrayList getTransactionBasedTypeTSMList(String searchType,String searchValue, UserSessionContext sessionContext,
				int parentCircleId,String parentCircleIdList, String accountLevelId, int lb, int ub,int accountLevel,DPCreateAccountDto accountDTO, int distTranctionId)
				throws VirtualizationServiceException;
		...
		public List getUserRoleList(int groupId)throws VirtualizationServiceException;
