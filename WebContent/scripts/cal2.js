...
var titleColor="#eab3b3";
var daysColor="#eab3b3";
var bodyColor="#ffffff";
var dayColor="#ffffff";
var currentDayColor="#333333";
var footColor="#eab3b3";
var borderColor="green";

var titleFontColor = "#333333";
var daysFontColor = "#ffffff";
var dayFontColor = "green";
...
// i am changing the format of calander 
...
//alert("i am in showCal");
  var lastCal=currentCal;
  var d=new Date(), hasCal=false;
//alert("i in after declration");
 currentCal = findCalendar(name);
//alert("value of currnet Cal is "+currentCal);
  if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) 
  {
	...
	//	alert("i in second if");
      cY=cd[0];
      cM=cd[1];
      dd=cd[2];
    }
    else {
    //alert("i in first else");
      cY=d.getFullYear();
      cM=d.getMonth();
      dd=d.getDate();
    }
  ...
  //alert("i am else ------");
    ...
    {
    //alert("i am else if_________------");
      window.status = "Form Field ["+currentCal.formName+"."+currentCal.field+"] not found.";
    }

    if (lastCal != null) {
   // alert("i am if in end of function ------");
      currentCal = lastCal;
    }
  }
}
