							...
							<table border="0" cellpadding="0" cellspacing="0" class="text">
								...
								<tr>
									<td colspan="4" class="pLeft10"><html:radio
										property="rdbSelect" onclick="hide()" styleId="self"
										value="self"></html:radio><strong><bean:message
										bundle="view" key="query.self" /></strong> <span class="pLeft15"></span>
									<html:radio onclick="show()" styleId="child" value="child"
										property="rdbSelect"></html:radio><strong><bean:message
										bundle="view" key="query.child" /></strong></td>
									...
									<table width="100%" align="center">
										<tr>
											<td width="150" class="text pLeft10" nowrap><font
												...
												bundle="view" key="query.childmobileno" /><span
												class="orange8"><font color="#ff0000">* </font></span> :<br>(<bean:message key="application.digits.mobile_number" bundle="view" />)</br></strong></font>
											</td>
											<td width="137"><font color="#003399"> <html:text
												property="childMobileNumber" styleClass="box"
												styleId="childMobileNumber" size="19" maxlength="10" onkeypress="isValidNumber()"/> </font>
											</td>
											<td class="text">&nbsp;</td>
										</tr>
								...
								<tr>
									...
									<html:hidden property="async" name="QueryFormBean"></html:hidden>
								...
								<tr>
									...
									<table border="1" cellspacing="0">
										...
										<!--	<td width="24%" align="center" class="darkBlueBg height19"><span
													...
													bundle="view" key="account.openingbalance" />(<bean:message
													bundle="view" key="application.currency" />)</span></td>
												<td width="25%" align="center" class="darkBlueBg height19"><span
													class="white10heading mLeft5 mTop5"><bean:message
													bundle="view" key="account.operatingbalance" />(<bean:message
													bundle="view" key="application.currency" />)</span></td>
											  -->
												<td width="23%" class="darkBlueBg height19"><span
													class="white10heading mLeft5 mTop5"><bean:message
													bundle="view" key="account.availablebalance" />(<bean:message
													bundle="view" key="application.currency" />)</span></td>
											</tr>
											<tr align="center" bgcolor="#FCE8E6">
										<!--	<td class=" height19"><span
													class="mLeft5 mTop5 mBot5 black10"><bean:write
													name="BALANCE_INFO" property="openingBalance"
													format="#0.00" /></span></td>
												<td class=" height19"><span
													class="mLeft5 mTop5 mBot5 black10"><bean:write
