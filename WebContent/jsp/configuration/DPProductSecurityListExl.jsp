...
<%@ page import = "java.util.*,com.ibm.dp.dto.DPDistSecurityDepositLoanDto" %>
...
<% 
    ...
    DPProductSecurityListDto dpDistSecurityDepositLoanDto = null;
%>
	<table border="1">
		<tr>
 		...
 		<%
 			while(itt.hasNext())
 			{
 				dpDistSecurityDepositLoanDto = (DPProductSecurityListDto) itt.next();
 				if(dpDistSecurityDepositLoanDto.getErr_msg()!= null && !dpDistSecurityDepositLoanDto.getErr_msg().equalsIgnoreCase("SUCCESS")){
 				%>
 				<tr>
	 				<td align="center"><%=dpDistSecurityDepositLoanDto.getErr_msg()%></td>
 				</tr>
 				<%
 				}
 				dpDistSecurityDepositLoanDto = null;
 			}
 		 %>
 	</table>
