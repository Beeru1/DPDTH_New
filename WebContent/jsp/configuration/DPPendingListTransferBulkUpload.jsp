...
function uploadExcel()
{
	...
	document.forms[0].action="dpPendingListTransferBulkupload.do?methodName=uploadExcel";
	loadSubmit();
...
<body>
<p></p>
<html:form action="/dpPendingListTransferBulkupload.do" method="post" name="DPPendingListTransferBulkUploadBean" type="com.ibm.dp.beans.DPPendingListTransferBulkUploadBean" enctype="multipart/form-data">
	...
	<TABLE>
		<TBODY>
			...
			<TD colspan="4" class="text"><BR>
				<IMG src="<%=request.getContextPath()%>/images/Pending_List_Transfer_BulkUpload.jpg"
	...
	<TABLE width="100%" border="0" cellpadding="2" cellspacing="2"
		...
		<TBODY>
			...
			<TR>
				...
				<strong><a href="dpPendingListTransferBulkupload.do?methodName=showFormatFile">Download Template File </a><strong>
			...
			<logic:equal name="DPPendingListTransferBulkUploadBean" property="error_flag" value="true" >
				  <tr>
				  	<td  align="center" colspan="2"><strong><font color="red">
							  The transaction could not be processed due to some errors. Click on <a href="dpPendingListTransferBulkupload.do?methodName=showErrorFile">View Details </a> 
				  ...
				  <tr>
				  	<td  align="center" colspan="2"><strong><font color="red">
					 <bean:write property="strmsg" name="DPPendingListTransferBulkUploadBean" /> </font><strong>
					 </td>
				  </tr>
