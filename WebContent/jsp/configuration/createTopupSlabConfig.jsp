...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function validateDetails(){
		...
		if(document.getElementById("transactionType").value!="POSTPAID_ABTS" &&	document.getElementById("transactionType").value!="POSTPAID_MOBILE"  && document.getElementById("transactionType").value!="POSTPAID_DTH" ){	
			if(form.processingCode.value==''){
				alert('<bean:message bundle="error" key="errors.topup.processingcodeinvalid" />')
		...
		document.getElementById("methodName").value="createTopupSlab";
	}
	...
	function disableValidity(){
		...
		if(document.getElementById("transactionType").value=="POSTPAID_ABTS" || document.getElementById("transactionType").value=="0" || document.getElementById("transactionType").value=="POSTPAID_DTH"
		||	document.getElementById("transactionType").value=="POSTPAID_MOBILE"  ){		
...
<BODY background="<%=request.getContextPath()%>/images/bg_main.gif"  bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0"
	marginheight="0" onkeypress="return checkKeyPressed();" onload="disableValidity()">
		...
		<TD valign="top" width="100%" height="100%"><html:form
			...
			<TABLE width="560" border="0" cellpadding="5" cellspacing="0"
				...
				<TR>
					...
					<IMG src="<%=request.getContextPath()%>/images/circleWiseSlabConfig.gif" width="505" height="22"
						alt=""></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD width="163"><FONT color="#3C3C3C"> <html:text
						...
						tabindex="6" name="topupSlabBean" onkeypress="isValidRate()"/> </FONT></TD>
				</TR>
				<TR>
					<TD width="126" class="text pLeft15" nowrap><STRONG><FONT
						color="#000000">
						
						<div id="divServiceTaxReq" style="display:block;"><bean:message
									bundle="view" key="topup.service_tax" />:</div>
								</FONT>
						<div id="divServiceTaxNotReq" style="display:none;"><bean:message
									bundle="view" key="topup.service_tax" /><FONT color="RED">*</FONT>:</div>
						
						
						</STRONG></TD>
					<TD width="171"><FONT color="#3C3C3C"> <html:text
						property="serviceTax" styleClass="box" maxlength="5" tabindex="7"
						name="topupSlabBean" onkeypress="isValidRate()"/> </FONT></TD>
						
						
					<TD width="135" class="text pLeft15" nowrap><STRONG><FONT
						color="#000000">
						
						<div id="divProcessingFeeReq" style="display:block;"><bean:message
									bundle="view" key="topup.processing_fee" />:</div>
								</FONT>
						<div id="divProcessingFeeNotReq" style="display:none;"><bean:message
									bundle="view" key="topup.processing_fee" /><FONT color="RED">*</FONT>:</div>
						
						
						</STRONG></TD>
					<TD width="163"><FONT color="#3C3C3C"> <html:text
						property="processingFee" styleClass="box" maxlength="14"
						tabindex="8" name="topupSlabBean" onkeypress="isValidPfee()"/> </FONT></TD>
				...
				<TR>
					<TD width="126" class="text pLeft15" nowrap><STRONG><FONT
						...
						<div id="divProcessingCodeReq" style="display:block;"><bean:message
									bundle="view" key="topup.processing_code" />:</div>
								</FONT>
					...
					<TD width="171"><FONT color="#3C3C3C"> <html:text
						...
						tabindex="9" name="topupSlabBean" /> </FONT></TD>
					...
					<TD width="135" class="text pLeft15" nowrap><STRONG><FONT
						...
						<div id="divInCardGroupReq" style="display:block;"><bean:message
									bundle="view" key="topup.incard_group" />:</div>
								</FONT>
					...
					<TD width="163"><FONT color="#3C3C3C"> <html:text
						...
						name="topupSlabBean" tabindex="10" /> </FONT></TD>
				</TR>
				<TR>
					...
					<TD width="126" class="text pLeft15" nowrap><STRONG><FONT
						...
						<div id="divValidityReq" style="display:block;"><bean:message
					...
					<TD width="171"><FONT color="#3C3C3C"> <html:text
						...
						maxlength="6" tabindex="11" name="topupSlabBean" onkeypress="isValidNumber()"/> </FONT></TD>
					<TD width="135" class="text pLeft15" nowrap></TD>
					<TD width="163"><html:hidden property="isCircleAdmin" 	name="topupSlabBean"  /></TD>
					...
					<TABLE width="140" border="0" cellspacing="0" cellpadding="5">
						<TR align="center" valign="top">
							<TD><INPUT type="submit" class="submit" name="Submit"
								tabindex="12" value="Submit" onclick="return validateDetails();"></TD>
							<TD><INPUT class="submit" type="button" onclick="resetAll();"
										name="Submit2" value="Reset" tabindex="13"></TD>
						</TR>
					</TABLE>
					</TD>
				</TR>
...
{
	if(document.getElementById("isCircleAdmin").value=="A")
	{  
