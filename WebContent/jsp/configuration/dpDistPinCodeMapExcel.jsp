...
<%@ page import = "java.util.*,com.ibm.dp.dto.DPDistPinCodeMapDto" %>
<html:html>
<HEAD>
<%@ page 
language="java"
	...
	<table border="1">
		<tr>
 		...
 		<%
 			while(itt.hasNext())
 			{
 				mapDto = (DPDistPinCodeMapDto) itt.next();
 				if(mapDto.getErr_msg()!= null && !mapDto.getErr_msg().equalsIgnoreCase("SUCCESS")){
 				%>
 				<tr>
	 				<td align="center"><%=mapDto.getErr_msg()%></td>
 				</tr>
 				<%
 				}
 				mapDto = null;
