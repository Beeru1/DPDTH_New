...
function uploadExcel()
{
	...
	document.forms[0].action="dpStockLevelBulkupload.do?methodName=uploadExcel";
	loadSubmit();
...
<body>
<p></p>
<html:form action="/dpStockLevelBulkupload.do" method="post" name="DPStockLevelBulkUploadBean" type="com.ibm.dp.beans.DPStockLevelBulkUploadBean" enctype="multipart/form-data">
	...
	<TABLE>
		<TBODY>
			...
			<TD colspan="4" class="text"><BR>
				<IMG src="<%=request.getContextPath()%>/images/stocklevel.jpg"
		...
		<TBODY>
			...
			<TR>
				...
				<TD class="txt" align="left" width="65%"><html:file property="uploadedFile"></html:file>
					<strong><a href="dpStockLevelBulkupload.do?methodName=exportExcel">Download Data File</a><strong>
				</TD>
			</TR>
			<tr>
			...
			<logic:equal name="DPStockLevelBulkUploadBean" property="error_flag" value="true" >
				  <tr>
				  	<td  align="center" colspan="2"><strong><font color="red">
							  The transaction could not be processed due to some errors. Click on <a href="dpStockLevelBulkupload.do?methodName=showErrorFile">View Details </a> 
				  ...
				  <tr>
				  	<td  align="center" colspan="2"><strong><font color="red">
					 <bean:write property="strmsg" name="DPStockLevelBulkUploadBean" /> </font><strong>
					 </td>
				  </tr>
