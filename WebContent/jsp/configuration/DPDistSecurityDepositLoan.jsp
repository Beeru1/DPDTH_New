...
function uploadExcel()
{
	...
	document.forms[0].action="dpSecurityDepostLoanBulkupload.do?methodName=uploadExcel";
	loadSubmit();
...
<body>
<p></p>
<html:form action="/dpSecurityDepostLoanBulkupload.do" method="post" name="DPDistSecurityDepositLoanBean" type="com.ibm.dp.beans.DPDistSecurityDepositLoanBean" enctype="multipart/form-data">
	...
	<TABLE>
		<TBODY>
			...
			<TD colspan="4" class="text"><BR>
				<IMG src="<%=request.getContextPath()%>/images/DistSecurityLoanDeposit.jpg"
	...
	<TABLE width="100%" border="0" cellpadding="2" cellspacing="2"
		...
		<TBODY>
			...
			<TR>
				...
				<strong><a href="dpSecurityDepostLoanBulkupload.do?methodName=exportExcel">Download Data File </a><strong>
			...
			<logic:equal name="DPDistSecurityDepositLoanBean" property="error_flag" value="true" >
				  <tr>
				  	<td  align="center" colspan="2"><strong><font color="red">
							  The transaction could not be processed due to some errors. Click on <a href="dpSecurityDepostLoanBulkupload.do?methodName=showErrorFile">View Details </a> 
				  ...
				  <tr>
				  	<td  align="center" colspan="2"><strong><font color="red">
					 <bean:write property="strmsg" name="DPDistSecurityDepositLoanBean" /> </font><strong>
					 </td>
				  </tr>
