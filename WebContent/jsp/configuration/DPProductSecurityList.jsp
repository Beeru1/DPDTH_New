...
function uploadExcel()
{
	...
	document.forms[0].action="dpProductSecurityListBulkupload.do?methodName=uploadExcel";
	loadSubmit();
	document.forms[0].submit();
}

function showError(){	
	document.forms[0].action="dpProductSecurityListBulkupload.do?methodName=showErrorFile";
	document.forms[0].submit();
	return true;
}
function exportToExcel(){
	document.forms[0].action = "dpProductSecurityListBulkupload.do?methodName=exportExcel";
	document.forms[0].submit();
}
...
<body>
<p></p>
<html:form action="/dpProductSecurityListBulkupload.do" method="post" name="DPProductSecurityListBean" type="com.ibm.dp.beans.DPProductSecurityListBean" enctype="multipart/form-data">
	...
	<TABLE>
		<TBODY>
			...
			<TD colspan="4" class="text"><BR>
				<IMG src="<%=request.getContextPath()%>/images/product_security.jpg"
	...
	<TABLE width="100%" border="0" cellpadding="2" cellspacing="2"
		...
		<TBODY>
			...
			<TR>
				...
				<strong><a href="dpProductSecurityListBulkupload.do?methodName=exportExcel">Download Data File </a><strong>
			...
			<logic:equal name="DPProductSecurityListBean" property="error_flag" value="true" >
				  <tr>
				  	<td  align="center" colspan="2"><strong><font color="red">
							  The transaction could not be processed due to some errors. Click on <a href="dpProductSecurityListBulkupload.do?methodName=showErrorFile">View Details </a> 
				  ...
				  <tr>
				  	<td  align="center" colspan="2"><strong><font color="red">
					 <bean:write property="strmsg" name="DPProductSecurityListBean" /> </font><strong>
					 </td>
				  </tr>
