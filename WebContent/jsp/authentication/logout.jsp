	...
	<TR valign="top">
		...
		<TABLE width="545" border="0" cellpadding="5" cellspacing="0"
			...
			<TR>
				...
				<IMG src="<%=request.getContextPath()%>/images/Thank.gif" width="505" height="22" alt="">
				</TD>
			</TR>
			<TR>
				<TD align="left" class="txt" colspan="4"><FONT color="#ff0000">
				<bean:message bundle="view" key="application.logout.message" /></FONT> <A
					href="<%=request.getContextPath()%>/jsp/authentication/login.jsp"><FONT color="#0000ff"><bean:message
					bundle="view" key="application.logout.redirect" /></FONT></A></TD>
			</TR>
		</TABLE>
		</TD>
	</TR>
