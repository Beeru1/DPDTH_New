...
function SelectAll()
    ...
    document.forms[0].action="manufacturerDetails.do?methodName=saveManufacturerDetails&manufacturerId=" + result +" &selectionFlag=" + flag ;
...
<table>
				<tr>
					...
					<IMG src="<%=request.getContextPath()%>/images/ManufacturerDetail.gif"
...
<table width="80%" align="left" border="1" cellpadding="0" cellspacing="0" id="tableTH"
			...
			<tbody>
				...
				<logic:empty name="ManufacturerDetailsBean" property="manufacturerList">
					<TR>
						<TD class="text" align="center" colspan="2" >No record found</TD>
					</TR>			
				</logic:empty>
		...
		<table width="10%" >
		<tr>		
			<td align="center" style="height: 130px;">	<input type="button" value="Submit" onclick="saveManufacturerDetails()" ></td>
		</tr>			
		</table>
</html:form>
</body>
