...
<%
System.out.println("--------------+++++++++++++++++++DpDcChurnStatus.jsp++++++++++++++++--------------------");
 %>
...
%>
				...
				<logic:notEmpty name="DpDcDamageStatusBean" property="dcNosListChurn">
					<logic:iterate name="DpDcDamageStatusBean" id="dcNosListChurn" indexId="i" property="dcNosListChurn">
						<TR  BGCOLOR='<%=((i.intValue()+1) % 2==0 ? rowDark : rowLight) %>'>
							...
							<TD align="center" class="text">
								<a href="#" onclick="printPage('<bean:write name='dcNosListChurn' property='strDCNo'/>')">
									<bean:message  bundle="view" key="dcStatus.View"/>				
								</a>	
							</TD>
							<TD align="center" class="text">
								<a href="#" onclick="viewSerialNo('<bean:write name='dcNosListChurn' property='strDCNo'/>')">
									<bean:message  bundle="view" key="dcStatus.View"/>				
								</a>	
							</TD>
							<TD align="center" class="text">
	...
	<html:hidden property="hidArrDcNosChurn"  name="DpDcDamageStatusBean" value=""/>
