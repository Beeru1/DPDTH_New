...
<logic:notEmpty property="dcDetailsCollectionList" name="DPReverseCollectionBean">
<fieldset style="border-width:5px"><legend> 
<STRONG><FONT size="3">

<bean:write property="churnDcGenerationLess" name="DPReverseCollectionBean"/>
 </FONT></STRONG>
...
<tr>
	...
	<td width="15%" align="center" style="border-right:1px solid;border-bottom:1px solid;"><strong>Vc Id</strong></td>
	<td width="15%" align="center" style="border-right:1px solid;border-bottom:1px solid;"><strong>SI Id</strong></td>
	<td width="15%" align="center" style="border-right:1px solid;border-bottom:1px solid;"><strong>Customer Id</strong></td>
	<td width="15%" align="center" style="border-right:1px solid;border-bottom:1px solid;"><strong>Ageing</strong></td>
	<td width="10%" align="center" style="border-right:1px solid;border-bottom:1px solid;"><strong>Collection Date</strong></td>
...
<tr>
    ...
    <td width="15%" align="center" style="border-right:1px solid;"><font size="2"><bean:write name="dcdetails" property="vc_id" /></font></td>
        <td width="15%" align="center" style="border-right:1px solid;"><font size="2"><bean:write name="dcdetails" property="si_id" /></font></td>
    <td width="15%" align="center" style="border-right:1px solid;"><font size="2"><bean:write name="dcdetails" property="customer_id" /></font></td>
    <td width="15%" align="center" style="border-right:1px solid;"><font size="2"><bean:write name="dcdetails" property="ageing" /></font></td>
...
<logic:notEmpty property="dcDetailsCollectionListChurn" name="DPReverseCollectionBean">
<fieldset style="border-width:5px">
<legend>
<STRONG><FONT size="3">

	<bean:write property="churnDcGenerationMore" name="DPReverseCollectionBean"/>
...
<logic:iterate id="dcdetails" property="dcDetailsCollectionListChurn"
				name="DPReverseCollectionBean">
<tr>
	<td width="10%" align="center" style="border-right:1px solid;"><font size="2"> <bean:write name="dcdetails" property="serial_no" /></font></td>
	<td width="15%" align="center" style="border-right:1px solid;"><font size="2"><bean:write name="dcdetails" property="product_name" /></font></td>
