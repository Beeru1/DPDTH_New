...
<tr>
	...
	<td width="20%" align="center" style="border-right:1px solid;border-bottom:1px solid;"><strong>Collection Type</strong></td>
	<td width="15%" align="center" style="border-right:1px solid;border-bottom:1px solid;"><strong>Defect Type</strong></td>
...
<tr>
	...
	<td width="20%" align="center" style="border-right:1px solid;"><font size="2"><bean:write name="dcdetails" property="collection_type" /></font></td>
	<td width="15%" align="center" style="border-right:1px solid;"><font size="2"><bean:write name="dcdetails" property="defect_type" /></font></td>
