...
<%
System.out.println("--------------+++++++++++++++++++SerialNo.jsp for Churn+++++++++++++++++++++++++--------------------");
 %>
...
<%try{%>
<logic:notEmpty property="dcNosListChurn" name="DpDcDamageStatusBean">
...
<td align="center"><h3>status</h3></td>
	...
	<logic:iterate id="serialNos" property="dcNosListChurn" name="DpDcDamageStatusBean">
	<tr>
