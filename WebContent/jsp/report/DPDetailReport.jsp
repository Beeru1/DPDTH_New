...
<SCRIPT language="javascript" type="text/javascript"><!-- 
	...
	function exportToExcel()
	{
		...
		var url = "reverseLogisticReport.do?methodName=getReverseLogisticDetailReportExcel&fromDate="+fromDate+"&toDate="+toDate+"&circleId="+circle+"&accountId="+accountId+"&distAccId="+distAccId;
		...
		<td>
			<TABLE width="570" border="0" cellpadding="5" cellspacing="0" class="text">
				<TR>
					...
					<IMG src="${pageContext.request.contextPath}/images/Report.gif"
