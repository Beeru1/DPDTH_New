...
<TITLE>Report Tertiary Sales</TITLE>

<script>
function exportToExcel(){
	var url="reportActionExcel.do?methodName=getReportData&reportId=2";
...
<tr>
	<TD colspan="4" class="text"><BR>
		<IMG src="<%=request.getContextPath()%>/images/tertiaryReport.gif"
	...
	<br><br>
		<table width="98%">
				<tr bgcolor="#CD0504" style="color:#ffffff !important;">
					...
					<td align="center"><bean:message bundle="view" key="report.mtdsales" /></td>
					<td align="center"><bean:message bundle="view" key="report.lmtdsales" /></td>
				</tr>
			<logic:iterate id="reportData" name="DPReportForm" property="reportDataList" indexId="m">
				<logic:equal value="zzzz" name="reportData" property="prodCat">
					<tr bgcolor="gray">
						...
						<td align="center"><bean:write name="reportData" property="mtdSales"/></td>
						<td align="center"><bean:write name="reportData" property="lmtdSales"/></td>
					</tr>
				</logic:equal>
