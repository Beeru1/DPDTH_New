...
<%
	...
	response.setHeader("content-disposition","attachment;filename=DistributorStockReport.xls");
...
%>
	<table border="1">
		<tr>
					...
					<td class="colhead" align="center"><b>   Sold    </b></td>
					<td class="colhead" align="center"><b>Closing stock</b></td>
		</tr>
 		<logic:iterate id="reportData" name="DPStockDetailsReportBean" property="distributorStockReportList">
				<tr>
