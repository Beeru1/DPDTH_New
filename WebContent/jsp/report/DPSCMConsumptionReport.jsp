...
<SCRIPT language="javascript" type="text/javascript"><!-- 
	...
	function exportToExcel()
	{
		...
		//alert('Acc Id : ' + accountId);
		//alert('dist acc Id : ' + distAccId);
		...
		var url = "initConsumptionReport.do?methodName=getConsumptionReportExcel&circleId="+circle+"&accountId="+accountId+"&distAccId="+distAccId+"&fromDate="+fromDate+"&toDate="+toDate;;
	...
	function getTsmName() 
	{
	    ...
	    if(levelId!=''){
			var url = "initConsumptionReport.do?methodName=initTsmReport&levelId="+levelId;
	...
	function getDistName()
	{
	    ...
	    var circleId = document.getElementById("circleid").value;
	 	...
	 	if(levelId!=''){
			var url = "initConsumptionReport.do?methodName=initDistReport&parentId="+levelId+"&circleId="+circleId;
			if(window.XmlHttpRequest) 
			{
				req = new XmlHttpRequest();
			}else if(window.ActiveXObject) 
...
<TABLE cellspacing="0" cellpadding="0" border="0" width="100%" 	height="100%" valign="top">
	...
	<html:form name="DPReverseLogisticReportFormBean" action="/initConsumptionReport" type="com.ibm.dp.beans.DPReverseLogisticReportFormBean" >
	<html:hidden property="methodName" value="getConsumptionReportExcel"/>
	...
	<TR valign="top">
		...
		<td align="left">
			<TABLE width="500" border="0" cellpadding="5" cellspacing="0" class="text" align="left">
				<TR>
					...
					<IMG src="${pageContext.request.contextPath}/images/Consumption Posting report.jpg"
				...
				<TR>
					<TD align="left">
						<b class="text pLeft15"><bean:message bundle="view"	key="report.tsm" /><FONT color="RED">*</FONT></b>
					</td>
					<TD align="left"><b>:</b>&nbsp;&nbsp;				   
				...
				<TR>
					<TD align="left">
						<b class="text pLeft15"><bean:message bundle="view"	key="report.distributor" /><FONT color="RED">*</FONT></b>
					</td>
					<TD align="left"><b>:</b>&nbsp;&nbsp;				   
	 			...
	 			<TR>
					<TD align="left"><b class="text pLeft15"><bean:message bundle="view"
						key="report.fromDate" /><FONT color="RED">*</FONT> </b></TD>
						<TD><FONT color="#003399"> <b>:</b>&nbsp;&nbsp;<html:text
				...
				<tr>	
					<TD align="left"><b class="text pLeft15"><bean:message bundle="view"
						key="report.toDate" > </bean:message><FONT color="RED">*</FONT></b></TD>
						<TD><FONT color="#003399"> <b>:</b>&nbsp;&nbsp;<html:text
		...
		<jsp:include page="../common/footer.jsp" flush="" /></TD>
	</TR>
