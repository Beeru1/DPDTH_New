...
<SCRIPT language="javascript" type="text/javascript"> 
	...
	// Changed on fixing CQ defect ID :  MASDB00150575
		...
		<td>
			<TABLE width="570" border="0" cellpadding="5" cellspacing="0"
						...
						<TR>
							...
							<IMG src="<%=request.getContextPath()%>/images/inventoryStatusReport.gif"
								width="505" height="22" alt=""></TD>
				
					</TR>
					<TR>
					<TD align="left" height="41" width="156">
						<b class="text pLeft15">Select Role</b>
					</td>
				...
				<TR>
					<TD align="left" height="46" width="156">
						<b class="text pLeft15">Select Account</b>
					</td>
				...
				<tr>
					...
					<td align="left" height="54" width="156">
						<html:button property="excelBtn" value="Export To CSV" onclick="exportToExcel();"></html:button>&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
