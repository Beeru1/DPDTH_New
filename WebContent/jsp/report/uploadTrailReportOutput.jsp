...
<TITLE>Upload Type Reports</TITLE>
...
<BODY>
	...
	<table border="1">
		<tr>
		<logic:iterate id="headerData" name="UploadTrailReportsBean" property="headers">
		...
		<logic:notEmpty name="UploadTrailReportsBean" property="output">
...
<%
try{
			session.setAttribute("UploadTrailReport", "done");
    }
catch (Exception e) 
	{
