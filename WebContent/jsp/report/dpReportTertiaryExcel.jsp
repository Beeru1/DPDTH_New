...
<%
	...
	response.setHeader("content-Disposition",
			"attachment;filename=reportTertiarySales.xls");
%>
	...
	<br><br>
		<table width="98%" border="1">
				<tr bgcolor="red">
					...
					<td class="colhead" align="center"><bean:message bundle="view" key="report.mtdsales" /></td>
					<td class="colhead" align="center"><bean:message bundle="view" key="report.lmtdsales" /></td>
				</tr>
