...
<SCRIPT language="javascript" type="text/javascript"><!-- 
	...
	function exportToExcel()
	{
		...
		var url = "lastPO.do?methodName=getlastPOReportExcel&circleId="+circle+"&accountId="+accountId+"&distAccId="+distAccId;
		...
		<td align="left">
			<TABLE width="500" border="0" cellpadding="5" cellspacing="0" class="text" align="left">
				<TR>
					...
					<IMG src="${pageContext.request.contextPath}/images/Last PO report.jpg"
