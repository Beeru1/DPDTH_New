...
<html>
    <head>
        ...
        <title>Tertiary Sales Report</title>
...
<display:table id="data" style="border=1px" requestURI="#" name="sessionScope.DPReportForm.reportDataList" decorator="org.displaytag.decorator.TotalTableDecorator" pagesize="10"  export="true" >
            ...
            <display:column property="lmtdSales" title="LMTD" sortable="true" total="true"/>
			<display:column property="mtdSales" title="MTD" sortable="true" total="true"/>
