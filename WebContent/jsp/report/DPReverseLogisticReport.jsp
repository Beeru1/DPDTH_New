...
<SCRIPT language="javascript" type="text/javascript"><!-- 
	...
	function exportToExcel()
	{
		...
		var url = "reverseLogisticReport.do?methodName=getReverseLogisticReportExcel&fromDate="+fromDate+"&toDate="+toDate+"&circleId="+circle+"&accountId="+accountId+"&distAccId="+distAccId;
	...
	function getTsmName() 
	{
	    ...
	    if(levelId!=''){
			var url = "reverseLogisticReport.do?methodName=initTsmReport&levelId="+levelId;
...
<TABLE cellspacing="0" cellpadding="0" border="0" width="100%" 	height="100%" valign="top">
	...
	<html:form name="DPReverseLogisticReportFormBean" action="/reverseLogisticReport" type="com.ibm.dp.beans.DPReverseLogisticReportFormBean" >
		...
		<td>
			<TABLE width="570" border="0" cellpadding="5" cellspacing="0" class="text">
				<TR>
					...
					<IMG src="${pageContext.request.contextPath}/images/reverseLogisticReport.jpg"
