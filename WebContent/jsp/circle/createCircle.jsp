...
if(remarks.value.length > 250){
	...
	//	alert("16");
		...
		//	alert("17");
			document.getElementById("methodName").value="createCircle";
		...
		<TD valign="top" width="100%" height="100%"><html:form
			...
			<TABLE width="545" border="0" cellpadding="5" cellspacing="0"
				...
				<TR>
					...
					<IMG src="<%=request.getContextPath()%>/images/createCircle.gif" width="505" height="22" alt=""></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD width="155"><FONT color="#003399"> <html:text
						...
						size="19" maxlength="10" name="CircleFormBean" />
						<script language="JavaScript">
new tcal ({
// form name //changed by Nehil
...
'controlname': 'saletaxdate'
				...
				<TR> 
					<TD width="120" class="text pLeft15" nowrap><STRONG><FONT
						color="#000000"><bean:message bundle="view"
						key="circle.regionid" /></FONT></STRONG><FONT color="RED">*</FONT>:</TD>
					<TD width="163"><FONT color="#003399"> <html:select
						property="regionId" name="CircleFormBean" tabindex="3"
						styleClass="w130">
						<html:option value="0">
...
<!-- 
					<html:submit property="submit" onclick="return validateForm();"></html:submit>
-->
					<html:button property="submit1" value="submit" onclick="return validateForm()">Submit</html:button>
							...
							<TD width="70"><INPUT class="submit" type="button" onclick="resetAll();"
										name="Submit2" value="Reset" tabindex="9"></TD>
						</TR>
					</TABLE>
					</TD>
				</TR>
