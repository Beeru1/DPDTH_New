...
<%@ page import = "java.util.*,com.ibm.dp.dto.NSBulkUploadDto" %>
<html:html>
<HEAD>
<%@ page 
language="java"
	...
	<table border="1">
		<tr>
 		...
 		<%
 			while(itt.hasNext())
 			{
 				nsBulkUploadDTO = (NSBulkUploadDto) itt.next();
 				if(nsBulkUploadDTO.getErr_msg()!= null && !nsBulkUploadDTO.getErr_msg().equalsIgnoreCase("SUCCESS")){
 				%>
 				<tr>
	 				<td align="center"><%=nsBulkUploadDTO.getErr_msg()%></td>
 				</tr>
 				<%
 				}
 				nsBulkUploadDTO = null;
 			}
 		 %>
 	</table>
<P><BR>
