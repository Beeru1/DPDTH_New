...
<%@ page import = "java.util.*,com.ibm.dp.dto.RecoPeriodDTO" %>
<html:html>
<HEAD>
<%@ page 
language="java"
...
%>
	<table border="1">
		<tr>
					<td class="colhead" align="center"><b>OLM Id</b></td>
 		...
 		<%
 			while(itt.hasNext())
 			{
 				...
 				%>
 				<tr>
	 				<td align="center">&nbsp;<%=recoPeriodDTO.getOlmId()%>&nbsp;</td>
	 				<%
	 				if(recoPeriodDTO.getErr_msg().equalsIgnoreCase("SUCCESS"))
	 				{
	 					 %>
	 						<td align="center">&nbsp;</td>
	 					 <%
	 				...
	 				{
	 					 %>
	 						<td align="center"><%=recoPeriodDTO.getErr_msg()%></td>
	 					 <%
	 				}
	 			%>	
 				</tr>
