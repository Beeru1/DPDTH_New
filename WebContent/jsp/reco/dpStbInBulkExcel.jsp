...
<%@page import="com.ibm.dp.dto.DPStbInBulkDTO"%>
<html:html>
<HEAD>
<%@ page 
language="java"
...
<TITLE>DP STB IN BULK UPLOAD</TITLE>
</HEAD>																		
<BODY>
		...
		<tr>
 		...
 		<%
 			while(itt.hasNext())
 			{
 				...
 				%>
 				<tr>
	 				<td align="center">&nbsp;<%=dpStbInBulkDTO.getSerial_no()%>&nbsp;</td>
	 				<%
	 				if(dpStbInBulkDTO.getErr_msg().equalsIgnoreCase("SUCCESS"))
	 				{
	 					 %>
	 						<td align="center">&nbsp;</td>
	 					 <%
	 				...
	 				{
	 					 %>
	 						<td align="center"><%=dpStbInBulkDTO.getErr_msg()%></td>
	 					 <%
	 				}
	 			%>	
 				</tr>
