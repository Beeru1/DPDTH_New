...
<%@page import="com.ibm.dp.dto.DPReverseChurnCollectionDTO;"%>
<html:html>
<HEAD>
<%@ page 
language="java"
		...
		<tr>
 		...
 		<%
 			while(itt.hasNext())
 			{
 				...
 				%>
 				<tr>
	 				<td align="center">&nbsp;<%=churnDTO.getSerial_Number()%>&nbsp;</td>
	 				<%
	 				if(churnDTO.getErr_msg().equalsIgnoreCase("SUCCESS"))
	 				{
	 					 %>
	 				...
	 				{
	 					 %>
	 						<td align="center"><%=churnDTO.getErr_msg()%></td>
	 					 <%
	 				}
	 			%>	
 				</tr>
