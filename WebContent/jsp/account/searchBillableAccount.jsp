...
<SCRIPT language="javascript" type="text/javascript"> 
	...
	function submitData(nextPage,searchType,searchValue,circleId,accountLevel){
		document.forms[0].action="initCreateAccount.do?methodName=getBillableAccountList&page="
	...
	function getAccount(){
	    ...
	    document.getElementById("methodName").value="getBillableAccountList";
	    var name="getBillableAccountList";
	    var send = "methodName="+name+"&circleid="+circleid+"&parent="+parent;
		return true;
	}
	function getCode(accountCode){
							...
							<logic:iterate id="account" name="DPCreateAccountForm"
								...
								<TR align="center" bgcolor="#FCE8E6">
									...
									<TD class="text" align="left"><html:button
										...
										onclick="getCode('${account.accountCode}')"
						...
						<TR align="center">
							...
							<TD align="center" bgcolor="#daeefc" colspan="7"><FONT
								...
								<c:if test="${PAGES>1}">
								    ...
								    <c:if test="${PRE>=1}">
										<A href="#"
											onclick="submitData('<c:out value='${PRE}' />','<c:out value='${searchType}' />','<c:out value='${searchValue}' />','<c:out value='${circleId}' />','<c:out value='${accountLevel}' />');"><
										Prev</A>
									</c:if>
