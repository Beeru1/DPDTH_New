...
/*		if(document.getElementById("accountCityId").value == null || document.getElementById("accountCityId").value == "0"){
	   ...
	   // Validate Description Length
		...
		document.getElementById("methodName").value="createBeat";
	}
	//Validity of Amount
...
<TABLE cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<TR valign="top">
		...
		<TD valign="top" width="100%" height="100%"><html:form
			...
			focus="beatName">
			<html:hidden property="methodName" styleId="methodName" value="createBeat"/>
			<TABLE width="545" border="0" cellpadding="5" cellspacing="0"
				class="text">
				<TR>
					<TD colspan="4" class="text"><BR>
					<IMG src="<%=request.getContextPath()%>/images/createBeat.gif" width="505" height="22" alt=""></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<td width="199" class="text pLeft15">
						<STRONG><FONT
						color="#000000"><bean:message bundle="view"
						key="beat.cityname" /> :</FONT></STRONG>
					</td>	
					<td width="155"><FONT color="#003399">
						<FONT color="#003399"> <html:text
						property="accountCityName" styleClass="box" styleId="accountCityName"
						size="19" tabindex="2" maxlength="64" name="DPCreateBeatForm" readonly="true"/> </FONT><FONT
						color="#ff0000" size="-2"></FONT>
<%-- 					<html:select
						property="accountCityId" tabindex="2" styleClass="w130">
						<html:option value="0">
							<bean:message key="application.option.select" bundle="view" />
						</html:option>
						<bean:define id="city"
						name="DPCreateBeatForm" property="cityList" />
						<logic:notEmpty name="DPCreateBeatForm" property="cityList">
						<html:options collection="city" labelProperty="accountCityName"
							property="accountCityId" />
						</logic:notEmpty>
					</html:select></FONT>	--%>
					</td>
					<html:hidden property="accountCityId" styleId="accountCityId" name="DPCreateBeatForm"/>
				</tr>
				<tr>
