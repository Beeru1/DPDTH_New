...
<BODY background="<%=request.getContextPath()%>/images/bg_main.gif"  bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onkeypress="return checkKeyPressed();" onload="setSearchControlDisabled()">
    ...
    <html:form action="initCreateAccount" focus="circleName">
			...
			<%-- 					<td align="center" bgcolor="#CD0504"><span
									class="white10heading mLeft5 mTop5"><bean:message bundle="view"
									key="account.openingbalance" /></span></td>
								<td align="center" bgcolor="#CD0504"><span
									class="white10heading mLeft5 mTop5"><bean:message bundle="view"
									key="account.operatingbalance" /></span></td>
								<td align="center" bgcolor="#CD0504"><span
									class="white10heading mLeft5 mTop5"><bean:message bundle="view"
									key="account.availablebalance" /></span></td>
								<td align="center" bgcolor="#CD0504"><span
									class="white10heading mLeft5 mTop5"><bean:message bundle="view"
									key="account.threshold" /></span></td>
								<td align="center" bgcolor="#CD0504"><span
									class="white10heading mLeft5 mTop5"><bean:message bundle="view"
									key="account.rate" /></span></td>	--%>
								<td align="center" bgcolor="#CD0504"><span
									class="white10heading mLeft5 mTop5"><bean:message bundle="view"
	...
	<%-- 						<td class="text"><bean:write name="account"
									property="openingBalance" format="#0.00"/></td>
								<td class="height19"><span class="mLeft5 mTop5 mBot5 black10"><bean:write name="account"
									property="operatingBalance" format="#0.00" /></span></td>	
								<td class="height19"><span class="mLeft5 mTop5 mBot5 black10"><bean:write name="account"
									property="availableBalance" format="#0.00" /></span></td>
								<td class="height19"><span class="mLeft5 mTop5 mBot5 black10"><bean:write name="account"
									property="threshold" format="#0.00" /></span></td>	
								<td class="height19"><span class="mLeft5 mTop5 mBot5 black10"><bean:write name="account"
									property="rate" format="#0.00" /></span></td>	--%>	
								<td class="height19"><span class="mLeft5 mTop5 mBot5 black10"><bean:write name="account"
