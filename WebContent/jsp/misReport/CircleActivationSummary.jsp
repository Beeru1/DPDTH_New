...
<SCRIPT language="javascript" type="text/javascript">
    ...
    function validate()
    
         {
	    	...
	    	//alert("endDate"+endDate+"days between "+daysBetween(startDate,endDate));
			...
			document.forms[0].action = "circleActivationSummaryReportAction.do?methodName=exportExcel";
...
<TABLE cellspacing="0" cellpadding="0" border="0" width="100%" 	height="100%" valign="top">
	...
	<html:form name="CircleActivationSummaryReportBean" action="/circleActivationSummaryReportAction.do" type="com.ibm.dp.beans.CircleActivationSummaryReportBean"  method="post"  enctype="multipart/form-data" >
	
	<html:hidden property="methodName" styleId="methodName" />
	<html:hidden property="hiddenCircleSelecIds" name="CircleActivationSummaryReportBean" />
			...
			<TABLE width="800" border="0" cellpadding="5" cellspacing="0" class="text"  align="top">
				<TR>
					<TD colspan="4" valign="bottom"  class="dpReportTitle">
								Circle Activation Summary Report
					</TD>
			...
			<TR>
				...
				<td height="46">	
						...
						<html:select  multiple="true"  property="circleId" styleId="circleId" style="width:150px;" size="6" onchange="setSelectedCircles();selectAllCircle();">
							<logic:notEmpty name="CircleActivationSummaryReportBean" property="circleList">
								 <html:optionsCollection name="CircleActivationSummaryReportBean"	property="circleList" label="strText" value="strValue"/> 
							</logic:notEmpty>
						</html:select>
				...
				<html:text 
						property="fromDate" styleClass="box" styleId="fromDate" readonly="true" 
						 size="38"  maxlength="15" name="CircleActivationSummaryReportBean" />
...
/*Method Added by Amrit for BFR 16 of Release 3*/
	...
	var url= "circleActivationSummaryReportAction.do?methodName=getReportDownloadStatus";
