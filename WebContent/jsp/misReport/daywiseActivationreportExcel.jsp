...
<BODY>
	...
	<table border="1">
		<tr>
		<logic:iterate id="headerData" name="DayWiseActivationSummaryReportBean" property="headers">
		...
		<logic:notEmpty name="DayWiseActivationSummaryReportBean" property="output">
...
try{
			...
			session.setAttribute("dayWiseActivationReport", "done");
    }
catch (Exception e) 
	{
