...
<TABLE cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<html:hidden property="showCircle" name="SerializedStockReportFormBean" />
	<html:hidden property="showTSM" name="SerializedStockReportFormBean" />
	<html:hidden property="showDist" name="SerializedStockReportFormBean" />
		...
		<TR valign="top">
			...
			<TABLE width="570" border="0" cellpadding="5" cellspacing="0"
				...
				<TR>
					...
					<!-- Page title start -->
					<IMG src="${pageContext.request.contextPath}/images/serializedStockAsOnDate.jpg"
				...
				<td>	
						...
						<logic:empty name="SerializedStockReportFormBean" property="tsmList">
				...
				<td>	
						<html:select   multiple="true"  property="distId" styleId="distId" style="width:150px;" size="3" onchange="getFseName();">							
							<logic:empty name="SerializedStockReportFormBean" property="distList">
						<html:option value="0"><bean:message bundle="dp" key="select.all" /></html:option>
						</logic:empty>
						...
						<logic:equal name="SerializedStockReportFormBean" property="groupId" value="7" >
						<tr>
						<TD align="center"><b class="text pLeft15">
						<bean:message bundle="dp"
						...
						<logic:empty name="SerializedStockReportFormBean" property="fseList">
							<html:option value="0"><bean:message bundle="dp" key="select.all" /></html:option>
					</logic:empty>
				...
				<td>	
						...
						<logic:empty name="SerializedStockReportFormBean" property="retList">
							<html:option value="0"><bean:message bundle="dp" key="select.all" /></html:option>
						</logic:empty>
