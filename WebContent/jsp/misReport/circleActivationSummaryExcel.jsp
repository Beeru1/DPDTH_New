...
<BODY>
	...
	<table border="1">
		<tr>
		<logic:iterate id="headerData" name="CircleActivationSummaryReportBean" property="headers">
		...
		<logic:notEmpty name="CircleActivationSummaryReportBean" property="output">
...
try{
			...
			session.setAttribute("CircleActivation", "done");
    }
catch (Exception e) 
	{
