...
<%
	...
	response.setHeader("content-disposition","attachment;filename=AccountDetailReport.xls");
...
%>
	<table border="1">
	<logic:equal name="AccountDetailReportBean" property="reportName" value="updateReport">
		<tr>
					...
					<td class="colhead" align="center"><b>Lapu No.1/Mobile1</b></td>
					<td class="colhead" align="center"><b>Lapu No 2./Mobile2</b></td>
					<td class="colhead" align="center"><b>FTA No.1/Mobile3</b></td>
					<td class="colhead" align="center"><b>FTA No 2./Mobile4</b></td>
					...
					<td class="colhead" align="center"><b>Mobile No./Retailer Lapu</b></td>
					...
					<td class="colhead" align="center"><b>Transaction Type</b></td>
		...
		<logic:notEqual name="AccountDetailReportBean" property="reportName" value="updateReport">
		<tr>
					<td class="colhead" align="center"><b>Login ID</b></td>
					<td class="colhead" align="center"><b>Account Type</b></td>
					<td class="colhead" align="center"><b>Name</b></td>
					<td class="colhead" align="center"><b>Lapu No.1/Mobile1</b></td>
					<td class="colhead" align="center"><b>Lapu No 2./Mobile1</b></td>
					<td class="colhead" align="center"><b>FTA No.1/Mobile1</b></td>
					<td class="colhead" align="center"><b>FTA No 2./Mobile1</b></td>
					<td class="colhead" align="center"><b>Parent Account Type</b></td>
					<td class="colhead" align="center"><b>Parent Account Name</b></td>															
					<td class="colhead" align="center"><b>Parent Login ID</b></td>
					<td class="colhead" align="center"><b>Circle</b></td>
		...
		<logic:notEmpty name="AccountDetailReportBean" property="reportList">
		<logic:equal name="AccountDetailReportBean" property="reportName" value="updateReport">
		<logic:iterate id="reportData" name="AccountDetailReportBean" property="reportList" indexId="m">
				<tr>
					...
					<td align="center"><bean:write name="reportData" property="transType"/></td>
...
try{
			...
			session.setAttribute("ReportAccountDetails", "done");
    }
catch (Exception e) 
	{
