...
<%try{%>
<logic:notEmpty property="deliveryChallanList" name="ViewPODetailsBean">
<div style="width:100%; height:500px; overflow:scroll;" >
<table border="2" width="100%" >
<tr><td>
<table border="0" width="100%" >
<tr>
<td align="left"><h3>Serials Numbers&nbsp;&nbsp;:&nbsp;&nbsp;</h3></td>
<td align="left"><h3>Product Name</h3></td>
<td align="left"><h3>Status</h3></td>
</tr>

	<logic:iterate id="serialNos" property="deliveryChallanList" name="ViewPODetailsBean">
	<tr>
	<td align="left"><b><bean:write name="serialNos" property="serialNo"/></b>&nbsp;&nbsp;<b>:</b>&nbsp;&nbsp;</td>
	<td align="left"><b><bean:write name="serialNos" property="strProductName"/></b></td>
	<td align="left"><b><bean:write name="serialNos" property="strStatus"/></b></td>
	</tr>
	</logic:iterate>
