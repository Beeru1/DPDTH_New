...
var url= "initAssignADStock.do?methodName=getProdListToFSE&cond1="+prodCategory;
var elementId = "product" ;
ajax(url,elementId);
}

//rajiv jha added for fse retailer start

function fseRetailerList(){
var Index = document.getElementById("accountFrom").selectedIndex;
var element=document.getElementById("accountFrom").value;
var url= "initAssignADStock.do?methodName=getAssignTo&cond1="+element+"&cond2=RETAssign";
var elementId = "accountTo" ;
ajax(url,elementId);
}
/*
var Index = document.getElementById("accountTo").selectedIndex;
var element=document.getElementById("accountTo").options[Index].value;
var url= "initAssignADStock.do?methodName=getFSERetailer&cond1="+element+"&cond2=FSEAssign";
var elementId = "accountTo" ;
ajax(url,elementId);
}*/

// rajiv jha added for fse retailer end
...
var url= "initAssignADStock.do?methodName=getStockQty&cond1="+accountFrom+"&cond2="+productId+"&cond3="+productName+"&strFlag=returnStock";
...
function insertData(){
		...
		if( validateData()== 1){
			...
			var param="methodName=returnStockToFSE&cond1="+categoryId+"&cond2="+productId+"&cond3="+
			...
			*/	
			...
			document.getElementById("cond6").value = endingSno;
			document.getElementById("cond7").value = startingSerial;
			...
			document.forms[0].action="initAssignADStock.do?methodName=returnStockToFSE";
...
function OpenSerialWindow(){
 ...
 {
     var url="viewSerialNoList.do?methodName=viewSerialNoList&cond1="+document.getElementById("accountFrom").value+"&cond2="+document.getElementById("accountTo").value+"&cond3="+document.getElementById("product").value+"&cond4="+document.getElementById("category").value;
...
<html:hidden property="accountToName" />
	...
	<TD colspan="4" class="text"><BR>
		<IMG src="${pageContext.request.contextPath}/images/returnStock.gif"
		width="505" height="22" alt="">
			...
			<TR  id="busCategory">
				<TD class="txt" width="222">Business Category<font color="red">*</font></TD>
			...
			<tr>
				...
				<TD class="txt" width="161">
				<html:select property="accountFrom" onchange="availableQty();showHideFind();fseRetailerList()" style="width:230px">
		...
		-->
			<TR>
				...
				<TD class="txt" width="161"><html:text name="AssignDistStockForm"
					property="assignedProdQty" style="width:230px" maxlength="6" readonly="false"></html:text><div id="find" style="display:none;">&nbsp;&nbsp;&nbsp;<a href="#" onClick="OpenSerialWindow()">Find</a></div></TD>
			</TR>
			<TR>
			...
			<TR>
				...
				<input type="button" value="Reset" onclick="resetting();"><input
					type="button" value="Return Stock To FSE" onclick="insertData();"></TD>
	...
	<br>
	<br>
<logic:notEqual value="true" name="AssignDistStockForm" property="validate_flag">	
<logic:equal value="SUCCESS" name="AssignDistStockForm" property="err_Msg">
	...
	<script>
		...
		<script>
	var validateFlag= '<bean:write name="AssignDistStockForm" property="validate_flag" />';
		var srNos= '<bean:write name="AssignDistStockForm" property="strfailSerialNo" />';
		if(validateFlag == "true")
		{
			alert("Serial Numbers ("+srNos+") can not be return to FSE as these are already activated in CPE");
		}
</script>
</html:form>
</body>
