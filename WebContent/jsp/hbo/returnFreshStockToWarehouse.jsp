...
var url= "initAssignADStock.do?methodName=getStockQtyDistributor&cond2="+productId+"&cond3="+flag;
...
function SubmitData(obj)
{
		...
		if(trim(agencyName) =="" || agencyName ==null || trim(docketNum)=="" || docketNum ==null){
			...
			alert("Please provide Courier Ageny and Docket no. ");
		 	return 0;
		}
...
//			document.forms[0].action="initAssignADStock.do?methodName=returnFreshStock&productIDWH="+productId+"&returnQuantity="+assignedProdQty+"&returnSerialNo="+startingSerial+"&avlSerialNO="+availableProdQty+"&productName="+productName+"&remarks="+remarks+"&categoryID="+categoryId;
			if(isSubmit ==true){
				document.forms[0].action="initAssignADStock.do?methodName=returnFreshStock";
...
<html:hidden property="jsArrprodId" name="AssignDistStockForm" />
	<html:hidden property="jsArrremarks" name="AssignDistStockForm" />
	<html:hidden property="jsArrqty" name="AssignDistStockForm" />
	<html:hidden property="jsSrNo" name="AssignDistStockForm" />
	...
	<TABLE WIDTH='100%'>
		<TR>
			<TD colspan="4" class="text">
				<IMG
				src="${pageContext.request.contextPath}/images/returnFreshStock.jpg"
		...
		<TR>
			...
			<table>
				<tbody>
					<tr>
						<td><logic:notEmpty name="AssignDistStockForm" property="message">
						<font color="red"><B><bean:write name="AssignDistStockForm" property="message"/></B></font>
						</logic:notEmpty>
					</td>
					</tr>
				</tbody>
		...
		<TR>
			...
			<td>
			<html:text name="AssignDistStockForm"	property="courierAgency" styleId="courierAgency" maxlength="100" onkeyup="return specialChar(this);" />
			</td>
			<td class="txt">
			...
			<td>
			<html:text name="AssignDistStockForm"	property="docketNum" styleId="docketNum" maxlength="50" onkeyup="return specialChar(this);" />
			</td>
			  </tr>
			  <TR>
				<TD class="txt"><bean:message bundle="hboView" key="returnFreshStock.DCRemarks"/><font color="red">*</font></TD>
				<TD class="txt"><html:textarea name="AssignDistStockForm"
					property="dcRemarks" style="width:230px" onkeypress="return maxlength();" onkeyup="return specialChar(this);"/></TD>
			  <TD align="right">
				<input type="button" value="Return To Warehouse" onclick="SubmitData(this);">
			  </TD>
			  </TR>
			</table>
			</TD>
