...
<SCRIPT language="javascript" type="text/javascript">
	...
	function submitData(nextPage,searchType,searchValue,status,startDate,endDate){
		document.forms[0].action="TransactionViewA2AAction.do?methodName=searchReportData&page="
...
<TABLE cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<TR valign="top">
		...
		<TD valign="top" width="100%" height="100%"><html:form
			action="TransactionViewA2AAction" focus="searchFieldName">
			...
			<TABLE width="680" border="0" cellpadding="5" cellspacing="0"
				...
				<TR>
					...
					<IMG
						src="<%=request.getContextPath()%>/images/viewAccToAccTrans.gif"
			...
			<TABLE width="680" border="0" cellpadding="5" cellspacing="0"
				...
				<TR>
					...
					&nbsp;&nbsp;&nbsp;&nbsp; <INPUT class="submit"
						...
						class="submit" type="button" onclick="resetAll();" name="Submit2"
					...
					<TABLE width="725" align="center" class="mLeft5">
						<logic:notEmpty name="TransactionRptA2AFormBean"
							...
							<logic:iterate id="transaction" name="TransactionRptA2AFormBean"
								...
								<TR bgcolor="#fce8e6">
									<TD class="text" nowrap><bean:write name="transaction"
										property="rowNum" /></TD>
									...
									<TD class="text"><logic:match name="transaction"
