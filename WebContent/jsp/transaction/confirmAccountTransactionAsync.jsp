...
<SCRIPT language="javascript" type="text/javascript"> 
 ...
 var buttonStatus = "false";
  ...
  // function that checks that is any field value blank or not
	...
	{
		document.forms[0].action="AccountTransaction.do?methodName="+'<bean:message bundle="view" key="button.confirm_cancel_async" />';
		document.forms[0].submit();
	}
</SCRIPT>
</HEAD>
					...
					<TABLE width="545" border="0" cellpadding="5" cellspacing="0"
						...
						<TR align="center">
							...
							<TD align="left"><INPUT type="button" class="submit"
								tabindex="6"
								value='<bean:message bundle="view" key="button.confirm_cancel_async" />'
