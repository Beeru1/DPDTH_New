...
function approveFnF(distId)
		{
		var remarkid="approverRemark_"+distId;
		...
		var url = "dpInitiateFnfAction.do?methodName=approveDistFnF&distId="+distId;
...
%>
<br>
 <IMG src="<%=request.getContextPath()%>/images/Approve FnF.gif"
		 ...
		 <bean:define id="distList" name="DIST_LIST" type="java.util.ArrayList" scope="request" />
		   <logic:notEmpty name="distList" >
			...
			<TR BGCOLOR='<%=((i.intValue()+1) % 2==0 ? rowDark : rowLight) %>'>
					...
					<TD align="center"><FONT color="black" class="text"><input type="text" name="approverRemark_${report.distId}" property="approverRemark" id="approverRemark_${report.distId}" ></FONT></TD>
					<TD align="center"><FONT color="black" class="text"><input type=button value="Approve FnF" onclick="approveFnF('${report.distId}')"/></FONT></TD>	
				</TR>
			</logic:iterate>
		  </logic:notEmpty>
	    </logic:notEmpty>
