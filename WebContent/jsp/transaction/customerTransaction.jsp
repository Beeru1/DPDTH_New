...
<TABLE cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<TR valign="top">
		...
		<TD valign="top" width="100%" height="100%"><html:form
			name="CustomerTransactionFormBean" action="/CustomerTransaction"
			method="post"
			type="com.ibm.virtualization.recharge.beans.CustomerTransactionFormBean"
				...
				<TR>
					...
					<TABLE width="545" border="0" cellpadding="5" cellspacing="0"
						...
						<TR>
							...
							<html:errors property="genericError" bundle="error" /> </STRONG></FONT></TD>
						</TR>
					</TABLE>
					</DIV>
					</TD>
					...
					<TABLE width="545" border="0" cellpadding="5" cellspacing="0"
						...
						<TR align="center">
							<TD align="right"><html:submit property="methodName"
								...
								<bean:message bundle="view" key="button.CustomerTransaction" />
							</html:submit></TD>
